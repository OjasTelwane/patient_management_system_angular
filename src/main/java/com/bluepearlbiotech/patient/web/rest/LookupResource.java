...
/**
 * REST controller for managing {@link com.bluepearlbiotech.patient.domain.Lookup}.
 */
@RestController
@RequestMapping("/api")
public class LookupResource {
  ...
  public ResponseEntity<Lookup> getLookup(@PathVariable UUID id) {
  ...
  public ResponseEntity<Void> deleteLookup(@PathVariable UUID id) {
